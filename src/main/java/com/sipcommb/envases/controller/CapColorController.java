...
public class CapColorController {
    ...
    public ResponseEntity<?> addCapColor(@RequestParam CapColorRequest capColorRequest, @RequestHeader("Authorization") String authHeader) {
    ...
    public ResponseEntity<?> getAllCapColors(
        ...
        try {
            ...
            Page<CapColorDTO> capColorDTO = capService.getAllCapColor(capRequest, color, pageable);
